...
def mesh_with_brain2mesh(labels_vol, max_vol=10.0):
    """
...
def generate_mni152_mesh(output_path, max_vol=10.0, min_dihedral=15.0, 
...
def main():
    ...
    p.add_argument('--max-vol',  type=float, default=10.0,
